...
export const subscriptionTiers: { [key: number]: SubscriptionTier } = {
  ...
  1: { amount: 1, days: 30, text: "1 month" },
  2: { amount: 2.5, days: 90, text: "3 months" },
  3: { amount: 4, days: 180, text: "6 months" },
  4: { amount: 6.5, days: 365, text: "12 months" },
  5: { amount: 11.5, days: 99999, text: "Lifetime" },
};
